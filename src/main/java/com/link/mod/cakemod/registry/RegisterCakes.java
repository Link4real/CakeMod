...
public class RegisterCakes {
    ...
    public static final Block GLOW_BERRY_CAKE = new BerryCake(FabricBlockSettings.of(Material.CAKE).strength(0.5f));
    ...
    public static void register() {
        ...
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "glow_berry_cake"), new BlockItem(GLOW_BERRY_CAKE, new FabricItemSettings().group(ItemGroup.FOOD)));
