...
public class Cakes {
    ...
    public static final Block RASPBERRY_CAKE = new RaspberryCakeBlock(FabricBlockSettings.of(Material.CAKE).strength(0.5f));
    public static final Block BUNDT_CAKE = new BundtCakeBlock(FabricBlockSettings.of(Material.CAKE).strength(0.5f));
    ...
    public static void registerCakes() {
        ...
        //Raspberry Cake (Croptopia Cake)
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "raspberry_cake"), RASPBERRY_CAKE);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "raspberry_cake"), new CroptopiaCakeItem(RASPBERRY_CAKE, new FabricItemSettings().group(Main.ITEM_GROUP).maxCount(1)));
        //Bundt Cake (Croptopia)
        Registry.register(Registry.BLOCK, new Identifier(MOD_ID, "bundt_cake"), BUNDT_CAKE);
        Registry.register(Registry.ITEM, new Identifier(MOD_ID, "bundt_cake"), new CroptopiaCakeItem(BUNDT_CAKE, new FabricItemSettings().group(Main.ITEM_GROUP).maxCount(1)));
    }
}
